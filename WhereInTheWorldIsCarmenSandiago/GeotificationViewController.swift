...
//  WhereInTheWorldIsCarmenSandiago
//
//  Created by P Leonard on 8/18/15.
//  Copyright (c) 2015 Jive. All rights reserved.
//
...
class GeotificationsViewController: UIViewController, AddGeotificationsViewControllerDelegate, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        locationManager.requestAlwaysAuthorization()        //Getting permissions from the users if we dont already have it.
    ...
    func regionWithGeotification(geotification: Geotification) -> CLCircularRegion {
        //Create circle around pin on map to notify when entering or exiting.
